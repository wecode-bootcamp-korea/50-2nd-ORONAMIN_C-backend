...
const createProduct = async (productName,price,description,brandId,scentId,imageId) => {
  return await appDataSource.query(`
    ...
    (name, price, description, brand_id,scent_id, image_id)
     values(
        '${productName}', ${price}, '${description}' ,${brandId} ,${scentId}, ${imageId})`);
};
...
const updateProduct = async (
  productId,productName,price,description,brandId,scentId,imageId) => {
  const updateFields = await updateQuery(
    productName,price,description,brandId,scentId,imageId);
  return await appDataSource.query(`
    update products set
    ${updateFields}
